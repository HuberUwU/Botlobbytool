...
// URLs de los juegos
const GAME_URLS = {
  mw2: 'https://www.xbox.com/fr-FR/play/launch/call-of-duty-modern-warfare-ii---b%C3%AAta-dmz/9PGLFS9MB9CG',
  mw3: 'https://www.xbox.com/fr-FR/play/launch/call-of-duty-modern-warfare-iii-lanceur/9PMFDKG5F9R7',
  bo6: 'https://www.xbox.com/fr-FR/play/launch/call-of-duty/9N201KQXS5BM'
};


// Script para simular que la ventana es siempre activa
...
class MainViewWindow {
  constructor(config) {
    ...
    this.currentGameUrl = GAME_URLS[config.game] || GAME_URLS.bo6; // URL del juego seleccionado
  ...
  createBrowserView(index) {
    ...
    // Cargar la URL del juego actual
    view.webContents.loadURL(this.currentGameUrl);
